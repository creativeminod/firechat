/* global jQuery, Firebase, FirechatUI, Chat */
jQuery( function ( $ )
{
	'use strict';
	...
	function toggleChat()
	{
		...
		$( '#chat-header' ).on( 'click', function ( e )
		{
			...
			$firechat.toggleClass( 'hidden' );
		} );
	}

	/**
	 * Initialize FireChat session for current user
	 * @return void
	 */
